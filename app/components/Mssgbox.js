    ...
    <div className='flex flex-col'>
      ...
      <div className='w-full h-[100vh] flex flex-col justify-center items-center'>
        ...
        <div className='flex space-x-5 py-3'>
          <input type='text' placeholder='Enter room name....' className='border border-slate-400' />
          <button className='border border-gray-400 bg-slate-300 rounded-md'>Create room</button>
        </div>

        <div className='flex space-x-5 py-3'>
          <input type='text' placeholder='Enter room name....' className='border border-slate-400' />
          <button className='border border-gray-400 bg-slate-300 rounded-md'>Join room</button>
        </div>
      </div>
